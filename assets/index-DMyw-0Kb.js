...
`].filter(hs).join(`
`),y=[m,Ac(t),"#define SHADER_NAME "+t.shaderName,g,t.useFog&&t.fog?"#define USE_FOG":"",t.useFog&&t.fogExp2?"#define FOG_EXP2":"",t.map?"#define USE_MAP":"",t.matcap?"#define USE_MATCAP":"",t.envMap?"#define USE_ENVMAP":"",t.envMap?"#define "+c:"",t.envMap?"#define "+u:"",t.envMap?"#define "+h:"",f?"#define CUBEUV_TEXEL_WIDTH "+f.texelWidth:"",f?"#define CUBEUV_TEXEL_HEIGHT "+f.texelHeight:"",f?"#define CUBEUV_MAX_MIP "+f.maxMip+".0":"",t.lightMap?"#define USE_LIGHTMAP":"",t.aoMap?"#define USE_AOMAP":"",t.emissiveMap?"#define USE_EMISSIVEMAP":"",t.bumpMap?"#define USE_BUMPMAP":"",t.normalMap?"#define USE_NORMALMAP":"",t.normalMap&&t.objectSpaceNormalMap?"#define OBJECTSPACE_NORMALMAP":"",t.normalMap&&t.tangentSpaceNormalMap?"#define TANGENTSPACE_NORMALMAP":"",t.clearcoat?"#define USE_CLEARCOAT":"",t.clearcoatMap?"#define USE_CLEARCOATMAP":"",t.clearcoatRoughnessMap?"#define USE_CLEARCOAT_ROUGHNESSMAP":"",t.clearcoatNormalMap?"#define USE_CLEARCOAT_NORMALMAP":"",t.iridescence?"#define USE_IRIDESCENCE":"",t.iridescenceMap?"#define USE_IRIDESCENCEMAP":"",t.iridescenceThicknessMap?"#define USE_IRIDESCENCE_THICKNESSMAP":"",t.specularMap?"#define USE_SPECULARMAP":"",t.specularIntensityMap?"#define USE_SPECULARINTENSITYMAP":"",t.specularColorMap?"#define USE_SPECULARCOLORMAP":"",t.roughnessMap?"#define USE_ROUGHNESSMAP":"",t.metalnessMap?"#define USE_METALNESSMAP":"",t.alphaMap?"#define USE_ALPHAMAP":"",t.alphaTest?"#define USE_ALPHATEST":"",t.sheen?"#define USE_SHEEN":"",t.sheenColorMap?"#define USE_SHEENCOLORMAP":"",t.sheenRoughnessMap?"#define USE_SHEENROUGHNESSMAP":"",t.transmission?"#define USE_TRANSMISSION":"",t.transmissionMap?"#define USE_TRANSMISSIONMAP":"",t.thicknessMap?"#define USE_THICKNESSMAP":"",t.decodeVideoTexture?"#define DECODE_VIDEO_TEXTURE":"",t.vertexTangents?"#define USE_TANGENT":"",t.vertexColors||t.instancingColor?"#define USE_COLOR":"",t.vertexAlphas?"#define USE_COLOR_ALPHA":"",t.vertexUvs?"#define USE_UV":"",t.uvsVertexOnly?"#define UVS_VERTEX_ONLY":"",t.gradientMap?"#define USE_GRADIENTMAP":"",t.flatShading?"#define FLAT_SHADED":"",t.doubleSided?"#define DOUBLE_SIDED":"",t.flipSided?"#define FLIP_SIDED":"",t.shadowMapEnabled?"#define USE_SHADOWMAP":"",t.shadowMapEnabled?"#define "+l:"",t.premultipliedAlpha?"#define PREMULTIPLIED_ALPHA":"",t.useLegacyLights?"#define LEGACY_LIGHTS":"",t.logarithmicDepthBuffer?"#define USE_LOGDEPTHBUF":"",t.logarithmicDepthBuffer&&t.rendererExtensionFragDepth?"#define USE_LOGDEPTHBUF_EXT":"","uniform mat4 viewMatrix;","uniform vec3 cameraPosition;","uniform bool isOrthographic;",t.toneMapping!==An?"#define TONE_MAPPING":"",t.toneMapping!==An?Ne.tonemapping_pars_fragment:"",t.toneMapping!==An?Ex("toneMapping",t.toneMapping):"",t.dithering?"#define DITHERING":"",t.opaque?"#define OPAQUE":"",Ne.encodings_pars_fragment,wx("linearToOutputTexel",t.outputEncoding),t.useDepthPacking?"#define DEPTH_PACKING "+t.depthPacking:"",`
`].filter(hs).join(`
`)),o=ia(o),o=Sc(o,t),o=wc(o,t),a=ia(a),a=Sc(a,t),a=wc(a,t),o=Ec(o),a=Ec(a),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(w=`#version 300 es
`,d=["precision mediump sampler2DArray;","#define attribute in","#define varying out","#define texture2D texture"].join(`
`)+`
`+d,y=["#define varying in",t.glslVersion===jl?"":"layout(location = 0) out highp vec4 pc_fragColor;",t.glslVersion===jl?"":"#define gl_FragColor pc_fragColor","#define gl_FragDepthEXT gl_FragDepth","#define texture2D texture","#define textureCube texture","#define texture2DProj textureProj","#define texture2DLodEXT textureLod","#define texture2DProjLodEXT textureProjLod","#define textureCubeLodEXT textureLod","#define texture2DGradEXT textureGrad","#define texture2DProjGradEXT textureProjGrad","#define textureCubeGradEXT textureGrad"].join(`
`)+`
`+y);const x=w+d+o,v=w+y+a,A=bc(s,35633,x),P=bc(s,35632,v);if(s.attachShader(p,A),s.attachShader(p,P),t.index0AttributeName!==void 0?s.bindAttribLocation(p,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(p,0,"position"),s.linkProgram(p),i.debug.checkShaderErrors){const C=s.getProgramInfoLog(p).trim(),N=s.getShaderInfoLog(A).trim(),Q=s.getShaderInfoLog(P).trim();let ae=!0,G=!0;if(s.getProgramParameter(p,35714)===!1){ae=!1;const z=Mc(s,A,"vertex"),j=Mc(s,P,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(p,35715)+`

Program Info Log: `+C+`
`+z+`
`+j)}else C!==""?console.warn("THREE.WebGLProgram: Program Info Log:",C):(N===""||Q==="")&&(G=!1);G&&(this.diagnostics={runnable:ae,programLog:C,vertexShader:{log:N,prefix:d},fragmentShader:{log:Q,prefix:y}})}s.deleteShader(A),s.deleteShader(P);let I;this.getUniforms=function(){return I===void 0&&(I=new gr(s,p)),I};let M;return this.getAttributes=function(){return M===void 0&&(M=Cx(s,p)),M},this.destroy=function(){n.releaseStatesOfProgram(this),s.deleteProgram(p),this.program=void 0},this.name=t.shaderName,this.id=bx++,this.cacheKey=e,this.usedTimes=1,this.program=p,this.vertexShader=A,this.fragmentShader=P,this}let Bx=0;class kx{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,s=this._getShaderStage(t),r=this._getShaderStage(n),o=this._getShaderCacheForMaterial(e);return o.has(s)===!1&&(o.add(s),s.usedTimes++),o.has(r)===!1&&(o.add(r),r.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new Vx(e),t.set(e,n)),n}}class Vx{constructor(e){this.id=Bx++,this.code=e,this.usedTimes=0}}function Gx(i,e,t,n,s,r,o){const a=new ah,l=new kx,c=[],u=s.isWebGL2,h=s.logarithmicDepthBuffer,f=s.vertexTextures;let m=s.precision;const g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function p(M,C,N,Q,ae){const G=Q.fog,z=ae.geometry,j=M.isMeshStandardMaterial?Q.environment:null,ee=(M.isMeshStandardMaterial?t:e).get(M.envMap||j),re=ee&&ee.mapping===Ir?ee.image.height:null,q=g[M.type];M.precision!==null&&(m=s.getMaxPrecision(M.precision),m!==M.precision&&console.warn("THREE.WebGLProgram.getParameters:",M.precision,"not supported, using",m,"instead."));const ue=z.morphAttributes.position||z.morphAttributes.normal||z.morphAttributes.color,le=ue!==void 0?ue.length:0;let Me=0;z.morphAttributes.position!==void 0&&(Me=1),z.morphAttributes.normal!==void 0&&(Me=2),z.morphAttributes.color!==void 0&&(Me=3);let k,he,me,W;if(q){const Pe=an[q];k=Pe.vertexShader,he=Pe.fragmentShader}else k=M.vertexShader,he=M.fragmentShader,l.update(M),me=l.getVertexShaderID(M),W=l.getFragmentShaderID(M);const ye=i.getRenderTarget(),xe=M.alphaTest>0,Se=M.clearcoat>0,we=M.iridescence>0;return{isWebGL2:u,shaderID:q,shaderName:M.type,vertexShader:k,fragmentShader:he,defines:M.defines,customVertexShaderID:me,customFragmentShaderID:W,isRawShaderMaterial:M.isRawShaderMaterial===!0,glslVersion:M.glslVersion,precision:m,instancing:ae.isInstancedMesh===!0,instancingColor:ae.isInstancedMesh===!0&&ae.instanceColor!==null,supportsVertexTextures:f,outputEncoding:ye===null?i.outputEncoding:ye.isXRRenderTarget===!0?ye.texture.encoding:li,map:!!M.map,matcap:!!M.matcap,envMap:!!ee,envMapMode:ee&&ee.mapping,envMapCubeUVHeight:re,lightMap:!!M.lightMap,aoMap:!!M.aoMap,emissiveMap:!!M.emissiveMap,bumpMap:!!M.bumpMap,normalMap:!!M.normalMap,objectSpaceNormalMap:M.normalMapType===sm,tangentSpaceNormalMap:M.normalMapType===eh,decodeVideoTexture:!!M.map&&M.map.isVideoTexture===!0&&M.map.encoding===Je,clearcoat:Se,clearcoatMap:Se&&!!M.clearcoatMap,clearcoatRoughnessMap:Se&&!!M.clearcoatRoughnessMap,clearcoatNormalMap:Se&&!!M.clearcoatNormalMap,iridescence:we,iridescenceMap:we&&!!M.iridescenceMap,iridescenceThicknessMap:we&&!!M.iridescenceThicknessMap,displacementMap:!!M.displacementMap,roughnessMap:!!M.roughnessMap,metalnessMap:!!M.metalnessMap,specularMap:!!M.specularMap,specularIntensityMap:!!M.specularIntensityMap,specularColorMap:!!M.specularColorMap,opaque:M.transparent===!1&&M.blending===Ui,alphaMap:!!M.alphaMap,alphaTest:xe,gradientMap:!!M.gradientMap,sheen:M.sheen>0,sheenColorMap:!!M.sheenColorMap,sheenRoughnessMap:!!M.sheenRoughnessMap,transmission:M.transmission>0,transmissionMap:!!M.transmissionMap,thicknessMap:!!M.thicknessMap,combine:M.combine,vertexTangents:!!M.normalMap&&!!z.attributes.tangent,vertexColors:M.vertexColors,vertexAlphas:M.vertexColors===!0&&!!z.attributes.color&&z.attributes.color.itemSize===4,vertexUvs:!!M.map||!!M.bumpMap||!!M.normalMap||!!M.specularMap||!!M.alphaMap||!!M.emissiveMap||!!M.roughnessMap||!!M.metalnessMap||!!M.clearcoatMap||!!M.clearcoatRoughnessMap||!!M.clearcoatNormalMap||!!M.iridescenceMap||!!M.iridescenceThicknessMap||!!M.displacementMap||!!M.transmissionMap||!!M.thicknessMap||!!M.specularIntensityMap||!!M.specularColorMap||!!M.sheenColorMap||!!M.sheenRoughnessMap,uvsVertexOnly:!(M.map||M.bumpMap||M.normalMap||M.specularMap||M.alphaMap||M.emissiveMap||M.roughnessMap||M.metalnessMap||M.clearcoatNormalMap||M.iridescenceMap||M.iridescenceThicknessMap||M.transmission>0||M.transmissionMap||M.thicknessMap||M.specularIntensityMap||M.specularColorMap||M.sheen>0||M.sheenColorMap||M.sheenRoughnessMap)&&!!M.displacementMap,fog:!!G,useFog:M.fog===!0,fogExp2:G&&G.isFogExp2,flatShading:!!M.flatShading,sizeAttenuation:M.sizeAttenuation,logarithmicDepthBuffer:h,skinning:ae.isSkinnedMesh===!0,morphTargets:z.morphAttributes.position!==void 0,morphNormals:z.morphAttributes.normal!==void 0,morphColors:z.morphAttributes.color!==void 0,morphTargetsCount:le,morphTextureStride:Me,numDirLights:C.directional.length,numPointLights:C.point.length,numSpotLights:C.spot.length,numSpotLightMaps:C.spotLightMap.length,numRectAreaLights:C.rectArea.length,numHemiLights:C.hemi.length,numDirLightShadows:C.directionalShadowMap.length,numPointLightShadows:C.pointShadowMap.length,numSpotLightShadows:C.spotShadowMap.length,numSpotLightShadowsWithMaps:C.numSpotLightShadowsWithMaps,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:M.dithering,shadowMapEnabled:i.shadowMap.enabled&&N.length>0,shadowMapType:i.shadowMap.type,toneMapping:M.toneMapped?i.toneMapping:An,useLegacyLights:i.useLegacyLights,premultipliedAlpha:M.premultipliedAlpha,doubleSided:M.side===zn,flipSided:M.side===kt,useDepthPacking:!!M.depthPacking,depthPacking:M.depthPacking||0,index0AttributeName:M.index0AttributeName,extensionDerivatives:M.extensions&&M.extensions.derivatives,extensionFragDepth:M.extensions&&M.extensions.fragDepth,extensionDrawBuffers:M.extensions&&M.extensions.drawBuffers,extensionShaderTextureLOD:M.extensions&&M.extensions.shaderTextureLOD,rendererExtensionFragDepth:u||n.has("EXT_frag_depth"),rendererExtensionDrawBuffers:u||n.has("WEBGL_draw_buffers"),rendererExtensionShaderTextureLod:u||n.has("EXT_shader_texture_lod"),customProgramCacheKey:M.customProgramCacheKey()}}function d(M){const C=[];if(M.shaderID?C.push(M.shaderID):(C.push(M.customVertexShaderID),C.push(M.customFragmentShaderID)),M.defines!==void 0)for(const N in M.defines)C.push(N),C.push(M.defines[N]);return M.isRawShaderMaterial===!1&&(y(C,M),w(C,M),C.push(i.outputEncoding)),C.push(M.customProgramCacheKey),C.join()}function y(M,C){M.push(C.precision),M.push(C.outputEncoding),M.push(C.envMapMode),M.push(C.envMapCubeUVHeight),M.push(C.combine),M.push(C.vertexUvs),M.push(C.fogExp2),M.push(C.sizeAttenuation),M.push(C.morphTargetsCount),M.push(C.morphAttributeCount),M.push(C.numDirLights),M.push(C.numPointLights),M.push(C.numSpotLights),M.push(C.numSpotLightMaps),M.push(C.numHemiLights),M.push(C.numRectAreaLights),M.push(C.numDirLightShadows),M.push(C.numPointLightShadows),M.push(C.numSpotLightShadows),M.push(C.numSpotLightShadowsWithMaps),M.push(C.shadowMapType),M.push(C.toneMapping),M.push(C.numClippingPlanes),M.push(C.numClipIntersection),M.push(C.depthPacking)}function w(M,C){a.disableAll(),C.isWebGL2&&a.enable(0),C.supportsVertexTextures&&a.enable(1),C.instancing&&a.enable(2),C.instancingColor&&a.enable(3),C.map&&a.enable(4),C.matcap&&a.enable(5),C.envMap&&a.enable(6),C.lightMap&&a.enable(7),C.aoMap&&a.enable(8),C.emissiveMap&&a.enable(9),C.bumpMap&&a.enable(10),C.normalMap&&a.enable(11),C.objectSpaceNormalMap&&a.enable(12),C.tangentSpaceNormalMap&&a.enable(13),C.clearcoat&&a.enable(14),C.clearcoatMap&&a.enable(15),C.clearcoatRoughnessMap&&a.enable(16),C.clearcoatNormalMap&&a.enable(17),C.iridescence&&a.enable(18),C.iridescenceMap&&a.enable(19),C.iridescenceThicknessMap&&a.enable(20),C.displacementMap&&a.enable(21),C.specularMap&&a.enable(22),C.roughnessMap&&a.enable(23),C.metalnessMap&&a.enable(24),C.gradientMap&&a.enable(25),C.alphaMap&&a.enable(26),C.alphaTest&&a.enable(27),C.vertexColors&&a.enable(28),C.vertexAlphas&&a.enable(29),C.vertexUvs&&a.enable(30),C.vertexTangents&&a.enable(31),C.uvsVertexOnly&&a.enable(32),M.push(a.mask),a.disableAll(),C.fog&&a.enable(0),C.useFog&&a.enable(1),C.flatShading&&a.enable(2),C.logarithmicDepthBuffer&&a.enable(3),C.skinning&&a.enable(4),C.morphTargets&&a.enable(5),C.morphNormals&&a.enable(6),C.morphColors&&a.enable(7),C.premultipliedAlpha&&a.enable(8),C.shadowMapEnabled&&a.enable(9),C.useLegacyLights&&a.enable(10),C.doubleSided&&a.enable(11),C.flipSided&&a.enable(12),C.useDepthPacking&&a.enable(13),C.dithering&&a.enable(14),C.specularIntensityMap&&a.enable(15),C.specularColorMap&&a.enable(16),C.transmission&&a.enable(17),C.transmissionMap&&a.enable(18),C.thicknessMap&&a.enable(19),C.sheen&&a.enable(20),C.sheenColorMap&&a.enable(21),C.sheenRoughnessMap&&a.enable(22),C.decodeVideoTexture&&a.enable(23),C.opaque&&a.enable(24),M.push(a.mask)}function x(M){const C=g[M.type];let N;if(C){const Q=an[C];N=Tm.clone(Q.uniforms)}else N=M.uniforms;return N}function v(M,C){let N;for(let Q=0,ae=c.length;Q<ae;Q++){const G=c[Q];if(G.cacheKey===C){N=G,++N.usedTimes;break}}return N===void 0&&(N=new Ux(i,C,M,r),c.push(N)),N}function A(M){if(--M.usedTimes===0){const C=c.indexOf(M);c[C]=c[c.length-1],c.pop(),M.destroy()}}function P(M){l.remove(M)}function I(){l.dispose()}return{getParameters:p,getProgramCacheKey:d,getUniforms:x,acquireProgram:v,releaseProgram:A,releaseShaderCache:P,programs:c,dispose:I}}function Hx(){let i=new WeakMap;function e(r){let o=i.get(r);return o===void 0&&(o={},i.set(r,o)),o}function t(r){i.delete(r)}function n(r,o,a){i.get(r)[o]=a}function s(){i=new WeakMap}return{get:e,remove:t,update:n,dispose:s}}function Wx(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.z!==e.z?i.z-e.z:i.id-e.id}function Tc(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function Cc(){const i=[];let e=0;const t=[],n=[],s=[];function r(){e=0,t.length=0,n.length=0,s.length=0}function o(h,f,m,g,p,d){let y=i[e];return y===void 0?(y={id:h.id,object:h,geometry:f,material:m,groupOrder:g,renderOrder:h.renderOrder,z:p,group:d},i[e]=y):(y.id=h.id,y.object=h,y.geometry=f,y.material=m,y.groupOrder=g,y.renderOrder=h.renderOrder,y.z=p,y.group=d),e++,y}function a(h,f,m,g,p,d){const y=o(h,f,m,g,p,d);m.transmission>0?n.push(y):m.transparent===!0?s.push(y):t.push(y)}function l(h,f,m,g,p,d){const y=o(h,f,m,g,p,d);m.transmission>0?n.unshift(y):m.transparent===!0?s.unshift(y):t.unshift(y)}function c(h,f){t.length>1&&t.sort(h||Wx),n.length>1&&n.sort(f||Tc),s.length>1&&s.sort(f||Tc)}function u(){for(let h=e,f=i.length;h<f;h++){const m=i[h];if(m.id===null)break;m.id=null,m.object=null,m.geometry=null,m.material=null,m.group=null}}return{opaque:t,transmissive:n,transparent:s,init:r,push:a,unshift:l,finish:u,sort:c}}function $x(){let i=new WeakMap;function e(n,s){const r=i.get(n);let o;return r===void 0?(o=new Cc,i.set(n,[o])):s>=r.length?(o=new Cc,r.push(o)):o=r[s],o}function t(){i=new WeakMap}return{get:e,dispose:t}}function Xx(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new R,color:new Xe};break;case"SpotLight":t={position:new R,direction:new R,color:new Xe,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new R,color:new Xe,distance:0,decay:0};break;case"HemisphereLight":t={direction:new R,skyColor:new Xe,groundColor:new Xe};break;case"RectAreaLight":t={color:new Xe,position:new R,halfWidth:new R,halfHeight:new R};break}return i[e.id]=t,t}}}function qx(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new _e};break;case"SpotLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new _e};break;case"PointLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new _e,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}let jx=0;function Yx(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function Zx(i,e){const t=new Xx,n=qx(),s={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0};for(let u=0;u<9;u++)s.probe.push(new R);const r=new R,o=new et,a=new et;function l(u,h){let f=0,m=0,g=0;for(let Q=0;Q<9;Q++)s.probe[Q].set(0,0,0);let p=0,d=0,y=0,w=0,x=0,v=0,A=0,P=0,I=0,M=0;u.sort(Yx);const C=h===!0?Math.PI:1;for(let Q=0,ae=u.length;Q<ae;Q++){const G=u[Q],z=G.color,j=G.intensity,ee=G.distance,re=G.shadow&&G.shadow.map?G.shadow.map.texture:null;if(G.isAmbientLight)f+=z.r*j*C,m+=z.g*j*C,g+=z.b*j*C;else if(G.isLightProbe)for(let q=0;q<9;q++)s.probe[q].addScaledVector(G.sh.coefficients[q],j);else if(G.isDirectionalLight){const q=t.get(G);if(q.color.copy(G.color).multiplyScalar(G.intensity*C),G.castShadow){const ue=G.shadow,le=n.get(G);le.shadowBias=ue.bias,le.shadowNormalBias=ue.normalBias,le.shadowRadius=ue.radius,le.shadowMapSize=ue.mapSize,s.directionalShadow[p]=le,s.directionalShadowMap[p]=re,s.directionalShadowMatrix[p]=G.shadow.matrix,v++}s.directional[p]=q,p++}else if(G.isSpotLight){const q=t.get(G);q.position.setFromMatrixPosition(G.matrixWorld),q.color.copy(z).multiplyScalar(j*C),q.distance=ee,q.coneCos=Math.cos(G.angle),q.penumbraCos=Math.cos(G.angle*(1-G.penumbra)),q.decay=G.decay,s.spot[y]=q;const ue=G.shadow;if(G.map&&(s.spotLightMap[I]=G.map,I++,ue.updateMatrices(G),G.castShadow&&M++),s.spotLightMatrix[y]=ue.matrix,G.castShadow){const le=n.get(G);le.shadowBias=ue.bias,le.shadowNormalBias=ue.normalBias,le.shadowRadius=ue.radius,le.shadowMapSize=ue.mapSize,s.spotShadow[y]=le,s.spotShadowMap[y]=re,P++}y++}else if(G.isRectAreaLight){const q=t.get(G);q.color.copy(z).multiplyScalar(j),q.halfWidth.set(G.width*.5,0,0),q.halfHeight.set(0,G.height*.5,0),s.rectArea[w]=q,w++}else if(G.isPointLight){const q=t.get(G);if(q.color.copy(G.color).multiplyScalar(G.intensity*C),q.distance=G.distance,q.decay=G.decay,G.castShadow){const ue=G.shadow,le=n.get(G);le.shadowBias=ue.bias,le.shadowNormalBias=ue.normalBias,le.shadowRadius=ue.radius,le.shadowMapSize=ue.mapSize,le.shadowCameraNear=ue.camera.near,le.shadowCameraFar=ue.camera.far,s.pointShadow[d]=le,s.pointShadowMap[d]=re,s.pointShadowMatrix[d]=G.shadow.matrix,A++}s.point[d]=q,d++}else if(G.isHemisphereLight){const q=t.get(G);q.skyColor.copy(G.color).multiplyScalar(j*C),q.groundColor.copy(G.groundColor).multiplyScalar(j*C),s.hemi[x]=q,x++}}w>0&&(e.isWebGL2||i.has("OES_texture_float_linear")===!0?(s.rectAreaLTC1=ve.LTC_FLOAT_1,s.rectAreaLTC2=ve.LTC_FLOAT_2):i.has("OES_texture_half_float_linear")===!0?(s.rectAreaLTC1=ve.LTC_HALF_1,s.rectAreaLTC2=ve.LTC_HALF_2):console.error("THREE.WebGLRenderer: Unable to use RectAreaLight. Missing WebGL extensions.")),s.ambient[0]=f,s.ambient[1]=m,s.ambient[2]=g;const N=s.hash;(N.directionalLength!==p||N.pointLength!==d||N.spotLength!==y||N.rectAreaLength!==w||N.hemiLength!==x||N.numDirectionalShadows!==v||N.numPointShadows!==A||N.numSpotShadows!==P||N.numSpotMaps!==I)&&(s.directional.length=p,s.spot.length=y,s.rectArea.length=w,s.point.length=d,s.hemi.length=x,s.directionalShadow.length=v,s.directionalShadowMap.length=v,s.pointShadow.length=A,s.pointShadowMap.length=A,s.spotShadow.length=P,s.spotShadowMap.length=P,s.directionalShadowMatrix.length=v,s.pointShadowMatrix.length=A,s.spotLightMatrix.length=P+I-M,s.spotLightMap.length=I,s.numSpotLightShadowsWithMaps=M,N.directionalLength=p,N.pointLength=d,N.spotLength=y,N.rectAreaLength=w,N.hemiLength=x,N.numDirectionalShadows=v,N.numPointShadows=A,N.numSpotShadows=P,N.numSpotMaps=I,s.version=jx++)}function c(u,h){let f=0,m=0,g=0,p=0,d=0;const y=h.matrixWorldInverse;for(let w=0,x=u.length;w<x;w++){const v=u[w];if(v.isDirectionalLight){const A=s.directional[f];A.direction.setFromMatrixPosition(v.matrixWorld),r.setFromMatrixPosition(v.target.matrixWorld),A.direction.sub(r),A.direction.transformDirection(y),f++}else if(v.isSpotLight){const A=s.spot[g];A.position.setFromMatrixPosition(v.matrixWorld),A.position.applyMatrix4(y),A.direction.setFromMatrixPosition(v.matrixWorld),r.setFromMatrixPosition(v.target.matrixWorld),A.direction.sub(r),A.direction.transformDirection(y),g++}else if(v.isRectAreaLight){const A=s.rectArea[p];A.position.setFromMatrixPosition(v.matrixWorld),A.position.applyMatrix4(y),a.identity(),o.copy(v.matrixWorld),o.premultiply(y),a.extractRotation(o),A.halfWidth.set(v.width*.5,0,0),A.halfHeight.set(0,v.height*.5,0),A.halfWidth.applyMatrix4(a),A.halfHeight.applyMatrix4(a),p++}else if(v.isPointLight){const A=s.point[m];A.position.setFromMatrixPosition(v.matrixWorld),A.position.applyMatrix4(y),m++}else if(v.isHemisphereLight){const A=s.hemi[d];A.direction.setFromMatrixPosition(v.matrixWorld),A.direction.transformDirection(y),d++}}}return{setup:l,setupView:c,state:s}}function Lc(i,e){const t=new Zx(i,e),n=[],s=[];function r(){n.length=0,s.length=0}function o(h){n.push(h)}function a(h){s.push(h)}function l(h){t.setup(n,h)}function c(h){t.setupView(n,h)}return{init:r,state:{lightsArray:n,shadowsArray:s,lights:t},setupLights:l,setupLightsView:c,pushLight:o,pushShadow:a}}function Jx(i,e){let t=new WeakMap;function n(r,o=0){const a=t.get(r);let l;return a===void 0?(l=new Lc(i,e),t.set(r,[l])):o>=a.length?(l=new Lc(i,e),a.push(l)):l=a[o],l}function s(){t=new WeakMap}return{get:n,dispose:s}}class Kx extends Zi{constructor(e){super(),this.isMeshDepthMaterial=!0,this.type="MeshDepthMaterial",this.depthPacking=nm,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class Qx extends Zi{constructor(e){super(),this.isMeshDistanceMaterial=!0,this.type="MeshDistanceMaterial",this.referencePosition=new R,this.nearDistance=1,this.farDistance=1e3,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.referencePosition.copy(e.referencePosition),this.nearDistance=e.nearDistance,this.farDistance=e.farDistance,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const ev=`void main() {
	gl_Position = vec4( position, 1.0 );
...
`)a=0,l-=r;else{const h=by(u,s,a,l,t);a+=h.offsetX,o.push(h.path)}}return o}function by(i,e,t,n,s){const r=s.glyphs[i]||s.glyphs["?"];if(!r){console.error('THREE.Font: character "'+i+'" does not exists in font family '+s.familyName+".");return}const o=new ay;let a,l,c,u,h,f,m,g;if(r.o){const p=r._cachedOutline||(r._cachedOutline=r.o.split(" "));for(let d=0,y=p.length;d<y;)switch(p[d++]){case"m":a=p[d++]*e+t,l=p[d++]*e+n,o.moveTo(a,l);break;case"l":a=p[d++]*e+t,l=p[d++]*e+n,o.lineTo(a,l);break;case"q":c=p[d++]*e+t,u=p[d++]*e+n,h=p[d++]*e+t,f=p[d++]*e+n,o.quadraticCurveTo(h,f,c,u);break;case"b":c=p[d++]*e+t,u=p[d++]*e+n,h=p[d++]*e+t,f=p[d++]*e+n,m=p[d++]*e+t,g=p[d++]*e+n,o.bezierCurveTo(h,f,m,g,c,u);break}}return{offsetX:r.ha*e,path:o}}class My extends Ba{constructor(e,t={}){const n=t.font;if(n===void 0)super();else{const s=n.generateShapes(e,t.size);t.depth=t.height!==void 0?t.height:50,t.bevelThickness===void 0&&(t.bevelThickness=10),t.bevelSize===void 0&&(t.bevelSize=8),t.bevelEnabled===void 0&&(t.bevelEnabled=!1),super(s,t)}this.type="TextGeometry"}}const Sy=xu({__name:"HelloWorld",setup(i){const e=new xy,t=new Th;t.onStart=()=>{},t.onLoad=()=>{},t.onProgress=(P,I,M)=>{},t.onError=P=>{console.log(`There was an error loading ${P}`)};const n=new ey(t),s=new Qv(t);n.load("/textures/door/color.jpg");const r=n.load("/textures/door/alpha.jpg");n.load("/textures/door/height.jpg"),n.load("/textures/door/normal.jpg"),n.load("/textures/door/ambientOcclusion.jpg"),n.load("/textures/door/metalness.jpg"),n.load("/textures/door/roughness.jpg");const a=n.load("/ThreeJSJourney/textures/matcaps/1.png"),l=n.load("/textures/gradients/3.jpg");l.magFilter=ft,l.minFilter=ft,l.generateMipmaps=!1,s.load(["/textures/environmentMaps/0/px.jpg","/textures/environmentMaps/0/nx.jpg","/textures/environmentMaps/0/py.jpg","/textures/environmentMaps/0/ny.jpg","/textures/environmentMaps/0/pz.jpg","/textures/environmentMaps/0/nz.jpg"]);const c={width:800,height:600},u=Ff("webgl");let h=null,f=null,m=null,g=null;const p=[];let d=null,y=null,w={font:null,size:.5,height:.2,curveSegments:12,bevelEnabled:!0,bevelThickness:.05,bevelSize:.02,bevelOffset:0,bevelSegments:5},x=null,v=null;const A=()=>{if(!u.value||!h||!f)return;const P=u.value;c.width=P.clientWidth,c.height=P.clientHeight,h.aspect=c.width/c.height,h.updateProjectionMatrix(),f.setSize(c.width,c.height),f.setPixelRatio(Math.min(window.devicePixelRatio,2)),m&&m.update()};return Mu(()=>{c.width=u.value.clientWidth,c.height=u.value.clientHeight,v=new pv,d=new Yv,d.matcap=a,d.wireframe=!1,e.load("fonts/helvetiker_bold.typeface.json",function(z){y=z,P()},function(z){},function(z){console.log("An error happened")});const P=()=>{if(!y||!d||!v)return;x&&(v.remove(x),x.geometry.dispose()),w.font=y;const z=new My("Hello Three.js",w);z.center(),x=new ln(z,d),v.add(x)};console.time("createText");const I=new ka(.3,.2,20,45);for(let z=0;z<1e3;z++){const j=new ln(I,d);j.position.x=(Math.random()-.5)*10,j.position.y=(Math.random()-.5)*10,j.position.z=(Math.random()-.5)*10,j.rotation.x=Math.random()*Math.PI,j.rotation.y=Math.random()*Math.PI;const ee=Math.random();j.scale.set(ee,ee,ee),v.add(j)}console.timeEnd("createText");const M=new oy;v.add(M);const C=new sy(16777215,.5);v.add(C);const N=new iy(16777215,.5);N.position.set(2,3,4),v.add(N),h=new Ut(75,c.width/c.height,1,1e3),h.position.set(2,2,2),h.lookAt(new R(0,0,0)),f=new Oa,f.setSize(c.width,c.height),u.value.appendChild(f.domElement),m=new ly(h,f.domElement),m.enableDamping=!0;const Q=new ry;function ae(){!h||!f||!m||(Q.getElapsedTime(),m.update(),f.render(v,h),requestAnimationFrame(ae))}ae(),window.addEventListener("resize",A);const G={useAlphaMap:function(){d&&(d.alphaMap?(d.alphaMap=null,console.log("移除alphaMap贴图")):(d.alphaMap=r,console.log("添加alphaMap贴图")),d.needsUpdate=!0)},flatShading:function(){d&&(d.flatShading?(d.flatShading=!1,console.log("取消平面着色")):(d.flatShading=!0,console.log("开启平面着色")),d.needsUpdate=!0)}};g=new Va,g.add(G,"useAlphaMap").name("alphaMap贴图"),g.add(G,"flatShading").name("开启平面着色"),g.add(d,"wireframe").name("线框模式"),g.add(w,"size").min(.1).max(5).step(.1).name("文本大小").onChange(P),g.add(w,"height").min(.1).max(5).step(.1).name("文本厚度").onChange(P),g.add(w,"curveSegments").min(1).max(20).step(1).name("曲线段数").onChange(P),g.add(w,"bevelEnabled").name("启用斜角").onChange(P),g.add(w,"bevelThickness").min(.01).max(1).step(.01).name("斜角厚度").onChange(P),g.add(w,"bevelSize").min(.01).max(1).step(.01).name("斜角大小").onChange(P),g.add(w,"bevelOffset").min(-1).max(1).step(.01).name("斜角偏移").onChange(P),g.add(w,"bevelSegments").min(1).max(10).step(1).name("斜角段数").onChange(P)}),Ea(()=>{window.removeEventListener("resize",A),f&&(f.dispose(),f=null),m&&(m.dispose(),m=null),g&&(g.destroy(),g=null),h=null,p.forEach(P=>{var I,M;(I=P.geometry)==null||I.dispose(),(M=P.material)==null||M.dispose()}),p.length=0,d==null||d.dispose(),d=null}),(P,I)=>(ku(),Sd("div",{ref_key:"webgl",ref:u,class:"webgl"},null,512))}}),wy=(i,e)=>{const t=i.__vccOpts||i;for(const[n,s]of e)t[n]=s;return t},Ey=wy(Sy,[["__scopeId","data-v-a9789500"]]),Ay=xu({__name:"App",setup(i){return(e,t)=>(ku(),wd(Ey,{msg:"Vite + Vue"}))}});lp(Ay).mount("#app");
